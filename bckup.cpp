...
void History::insert(Transaction *p_new_trans)
{
  ...
  {
    Transaction *p_ointerj = p_head;
    while (p_ointerj->get_next() != NULL)
    {
      p_ointerj = p_ointerj->get_next();
    }
    p_ointerj->set_next(p_new_trans);
...
void History::sort_by_date()
{
  ...
  // Transaction *new_list_pointer = this->p_head;
  // new_list_pointer->set_next(NULL);
  // p_head = p_head->get_next();
  // while (this->p_head != nullptr)
  // {
  //   Transaction *after = new_list_pointer->get_next();
  //   Transaction *before = new_list_pointer;
  //   Transaction *now = NULL;

  //   if (*p_head < *new_list_pointer)
  //   {
  //     now = p_head;
  //     p_head = p_head->get_next();
  //     now->set_next(before);
  //     new_list_pointer = now;
  //   }
  //   // find the right place
  //   while (after->get_next() != NULL && *after < *p_head)
  //   {
  ...
  //   }
  // }
  // p_head = new_list_pointer;

  // Transaction *new_head_pointer = p_head;

  // while (p_head != nullptr)
  // {
  //   Transaction *new_t_pointer = NULL;
  //   Transaction *hold_pointer = new_head_pointer;
  //   Transaction *hold_before = new_head_pointer;

  //   p_head = p_head->get_next();
  //   printf("%p\n", p_head);
  //   new_t_pointer = p_head->get_next();
  //   new_t_pointer->set_next(NULL);
  //   if (*new_t_pointer < *new_head_pointer)
  //   {
  //     new_t_pointer->set_next(new_head_pointer);
  //     new_head_pointer = new_t_pointer;
  //   }
  //   else
  //   {
  //     while ((hold_pointer->get_next() != NULL) && !(*new_t_pointer < *hold_pointer->get_next()))
  //     {
  //       hold_before = hold_pointer;
  //       hold_pointer = hold_pointer->get_next();
  //     }
  //     if (hold_pointer->get_next() == NULL)
  //     {
  //       hold_pointer->set_next(new_t_pointer);
  //     }
  //     else
  //     {
  //       new_t_pointer->set_next(hold_pointer);
  //       hold_before->set_next(new_t_pointer);
  //     }
  //   }
  // }
  // p_head = new_head_pointer;
}
...
double History::compute_cgl(unsigned int year)
{
  ...
  while (comcgl != NULL && comcgl->get_year() == year)
  {
